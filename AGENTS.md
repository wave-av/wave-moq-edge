...
Agent contract for this repo. Inherits the org default (<https://github.com/wave-av/.github/blob/main/AGENTS.md>) and the org's internal repo-governance standard (private).
...
4. **The 24-axis model taxonomy** lives in the org's internal model-routing config (private, calibrated_at 2026-08-24).
...
Top-level directories: __tests__, docs, examples, scripts, src, tools.
