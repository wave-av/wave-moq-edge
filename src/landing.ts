...
<p class="lead">moq-edge moves live media sub-second across Cloudflare's global edge — publish a track, subscribe to it, and every viewer sees the moment while it's still the moment. Live now on IETF MoQ draft-18. Apache-2.0 open source.</p>
...
export function landingPage(): string {
  return shell({
    ...
    description: 'moq-edge moves live media sub-second across Cloudflare\'s global edge — publish a track, subscribe to it, and every viewer sees the moment while it\'s still the moment. Live now on IETF MoQ draft-18. Apache-2.0 open source.',
